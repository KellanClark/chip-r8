...
_copyright db	'Copyright (c) 2005-2023, revolution',0Dh,0Ah,\
		'Some portions copyright (c) 1999-2016, Tomasz Grysztar',0Dh,0Ah,0

_logo db 'flat assembler for ARM  version ',ARM_VERSION_STRING,' (built on fasm ',VERSION_STRING,')',0
_usage db 0Dh,0Ah
       db 'usage: fasmarm <source> [output]',0Dh,0Ah
