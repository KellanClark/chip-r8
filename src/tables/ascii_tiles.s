; Hacky assembler stuff because I don't want to rewrite this whole thing

virtual at 0
	virtbuffer::
	; Using the first 32 tiles for sprite data because I don't want to expand it manually
	...
	db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00  ;
	db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00  ;
	db 0x00, 0x00, 0x00, 0x3F, 0x3F, 0x00, 0x00, 0x00  ;  Arrow Left
	db 0x60, 0x30, 0x18, 0xFC, 0xFC, 0x18, 0x30, 0x60  ;  Arrow Right
	db 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF  ;  Solid Color
	db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00  ;
	db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00  ;
	db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00  ;
	db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00  ;
...
ascii_tiles_start:
repeat virtbufsize
	load val byte from virtbuffer:%-1
	repeat 8
		if ((val shr (8 - %)) and 1) = 1
			db 0x01
		else
